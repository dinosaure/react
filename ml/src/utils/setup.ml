...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5be4c942722fd1e2183915a13ba47f63) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("cp", ["_build/src/utils.js"; "./utils.js"])))
                 ]
            };
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "utils.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\157`a\248\207D\031\222\164t\016\218\003|\247\200";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
