...
(* OASIS_START *)
(* DO NOT EDIT (digest: c2dcc00297c8736389c07b5ed91a68e1) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("cp", ["_build/src/react.js"; "./react.js"])))
                 ]
            };
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "react.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\169\179D+\186\0147?\021E\231\139\200\238\018j";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
